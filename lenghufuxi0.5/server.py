...
def generate_questions():
    ...
    # 移除手动设置随机种子，让random模块自己管理随机种子，确保更好的随机性
    ...
    all_questions = [
        ...
        # 为着陆课程添加相关题目
        {
            "question": "鸟类飞行的主要动力来源是什么？",
            "options": ["翅膀的扇动", "尾巴的摆动", "脚的蹬踏", "嘴的啄食"],
            "answer": 0,
            "category": "生物",
            "course_id": 8,  # 鸟与空气动力学
            "explanation": "鸟类飞行的主要动力来源是翅膀的扇动，通过翅膀的上下扇动产生升力和推力。"
        },
        {
            "question": "空气动力学中，物体在空气中运动时受到的阻力与什么有关？",
            "options": ["物体的速度", "物体的颜色", "物体的温度", "物体的味道"],
            "answer": 0,
            "category": "物理",
            "course_id": 8,  # 鸟与空气动力学
            "explanation": "空气动力学中，物体在空气中运动时受到的阻力与物体的速度有关，速度越快，阻力越大。"
        },
        {
            "question": "希罗喷泉的工作原理主要利用了什么？",
            "options": ["气压差", "重力", "磁力", "电力"],
            "answer": 0,
            "category": "物理",
            "course_id": 10,  # 希罗喷泉
            "explanation": "希罗喷泉的工作原理主要利用了气压差，通过水位变化产生的气压差推动水流循环。"
        },
        # 为探索课程添加相关题目
        {
            "question": "声音是通过什么传播的？",
            "options": ["介质振动", "光线反射", "磁场变化", "电场变化"],
            "answer": 0,
            "category": "物理",
            "course_id": 9,  # 声音——看不见的波
            "explanation": "声音是通过介质振动传播的，声音需要介质才能传播，在真空中无法传播。"
        },
        {
            "question": "声波的频率决定了声音的什么特性？",
            "options": ["音调", "响度", "音色", "速度"],
            "answer": 0,
            "category": "物理",
            "course_id": 9,  # 声音——看不见的波
            "explanation": "声波的频率决定了声音的音调，频率越高，音调越高；频率越低，音调越低。"
        }
    ]
    ...
    # 确保返回5道题，使用随机选择并避免重复
    while len(generated_questions) < 5:
        if available_questions:
            # 随机选择一道题
            random_index = random.randint(0, len(available_questions) - 1)
            selected_question = available_questions.pop(random_index)
            generated_questions.append(selected_question)
        else:
            # 如果没有更多题目，从原始题库中重新随机选择
            if all_questions:
                random_index = random.randint(0, len(all_questions) - 1)
                selected_question = all_questions[random_index]
                generated_questions.append(selected_question)
            else:
                # 如果完全没有题目，跳出循环
                break
